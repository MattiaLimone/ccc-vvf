        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">IMPORTA PERSONALE</h3></div>
                    <div class="card card-body">
                        <form action="<?= base_url('admin/dashboard/import/upload') ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                <input class="form-control form-control-sm" id="xmlFile" name="xmlFile" type="file" accept=".xml">
                            </div>
                            <div class="float-end">
                                <input type="submit" class="btn btn-primary center" id="uploadFile" value="Upload">
                            </div>
                        </form>
                    </div>
                    <div class="card card-body border-0 shadow table-wrapper table-responsive">
                        <form action="<?= base_url('admin/dashboard/import/import') ?>" method="post">
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            if(isset($xmlList)){
                                ...
                                foreach($xmlList as $row) {
                                    foreach ($row as $user) {
                                        if ($user['DATNASDIP'] == null)
                                            $user['DATNASDIP'] = "NULL";

                                        if ($user['DATAINI_QUAL'] == null)
                                            $user['DATAINI_QUAL'] = "NULL";

                                        if ($user['DATA_ASSUNZIONE'] == null)
                                            $user['DATA_ASSUNZIONE'] = "NULL";

                                        if ($user['DATAASGN'] == null)
                                            $user['DATAASGN'] = "NULL";

                                        if ($user['DATA_CESSAZIONE'] == null)
                                            $user['DATA_CESSAZIONE'] = "NULL";

                                        if ($user['DATA_REINTEGRO'] == null)
                                            $user['DATA_REINTEGRO'] = "NULL";

                                        echo "<tr>";
                                        echo "<td></td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['NOMDIP']."'>" . $user['NOMDIP'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CGNDIP']."'>" . $user['CGNDIP'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODFISDIP']."'>" . $user['CODFISDIP'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['SESDIP']."'>" . $user['SESDIP'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['DATNASDIP']."'>" . $user['DATNASDIP'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['NUMISCRUO']."'>" . $user['NUMISCRUO'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODQUALIFICA']."'>" . $user['CODQUALIFICA'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['RUOLOQUAL']."'>" . $user['RUOLOQUAL'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['MATDIP']."'>" . $user['MATDIP'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['DATAINI_QUAL']."'>" . $user['DATAINI_QUAL'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['DATA_ASSUNZIONE']."'>" . $user['DATA_ASSUNZIONE'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODTUR']."'>" . $user['CODTUR'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['VIARES']."'>" . $user['VIARES'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CAPRES']."'>" . $user['CAPRES'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODCOMUNE_RES']."'>" . $user['CODCOMUNE_RES'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODPROV_RISIEDE_IN']."'>" . $user['CODPROV_RISIEDE_IN'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CF_NOMEQUALIFICA']."'>" . $user['CF_NOMEQUALIFICA'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CF_INDIRIZZO']."'>" . $user['CF_INDIRIZZO'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CF_TELEFONO']."'>" . $user['CF_TELEFONO'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CF_DT_ASSUNZIONE']."'>" . $user['CF_DT_ASSUNZIONE'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODSEDE']."'>" . $user['CODSEDE'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CODDTC']."'>" . $user['CODDTC'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['DATAASGN']."'>" . $user['DATAASGN'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['DATA_CESSAZIONE']."'>" . $user['DATA_CESSAZIONE'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['DATA_REINTEGRO']."'>" . $user['DATA_REINTEGRO'] . "</td>";
                                        echo "<td><input type='hidden' name='col".$counter."[]' value='".$user['CF_DESDTC']."'>" . $user['CF_DESDTC'] . "</td>";
                                        echo "</tr>";
                                        $counter++;
                                    }
                            ...
                            <div class="float-end">
                                <input type="submit" class="btn btn-primary center" id="uploadFile" value="Importa">
                            </div>
                        </form>
                    </div>
                </div>
