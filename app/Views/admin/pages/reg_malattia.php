        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Modulo inserimento malattia</h3></div>
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url('admin/dashboard/addmalattia/insert') ?>" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Nome" disabled/>
                                <label for="selectUser">Email</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input  class="form-control" name="address" id="address" type="text" placeholder="Nome" disabled/>
                                <label for="selectUser">Indirizzo</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="telephone" id="telephone"  placeholder="Nome" disabled/>
                                <label for="selectUser">Telefono</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input  class="form-control" name="tipo" id="tipo" type="text" placeholder="Nome" disabled/>
                                <label for="selectUser">Tipologia</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="reason" id="reason"  placeholder="Nome" disabled/>
                                <label for="selectUser">Motivazione</label>
                            </div>
                            ...
                            <div class="form-floating mb-3" >
                                <div class="input-group" style="height: 3.625rem">
                                    ...
                                    <input class="form-control font-medium" id="inizio_malattia" name="inizio_malattia" type="text" placeholder="Data inizio ferie"
                                           autocomplete="off"
                                           required disabled/>
                                </div>
                            </div>
                            <div class="form-floating mb-3" >
                                <div class="input-group" style="height: 3.625rem">
                                    ...
                                    <input class="form-control font-medium" id="fine_malattia" name="fine_malattia" type="text" placeholder="Data fine ferie"
                                           autocomplete="off"
                                           required disabled/>
                                </div>
                            </div>
...
<?= $this->section("footer") ?>
    ...
    <script>
        const datepicker1 = new Datepicker(document.getElementById("inizio_malattia"),
            {
                language: 'it',
                format: 'dd-M-yyyy',
            });
        const datepicker2 = new Datepicker(document.getElementById("fine_malattia"),
            {
                language: 'it',
                format: 'dd-M-yyyy',
            });
            ...
            onSelectItem: ({label, value}) => {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#inizio_malattia').prop( "disabled", false );
                        $('#fine_malattia').prop( "disabled", false );
                    },
