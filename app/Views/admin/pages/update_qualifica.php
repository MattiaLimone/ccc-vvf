        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Modulo modifica qualifica</h3></div>
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url('admin/dashboard/updatequalifica/insert') ?>" method="post">
                            ...
                            <div class="col-md-12">
                                ...
                                <select id="grado" name="grado" class="form-select" aria-label=".form-select-lg" style="padding-top: 0.625rem;" disabled>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0 float-end">
                                <input type="submit" class="btn btn-primary center" value="Modifica">
                            </div>
                        </form>
                    </div>
                </div>
