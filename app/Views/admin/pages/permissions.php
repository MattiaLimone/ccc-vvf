        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Modifica Permessi</h3></div>
                    <div class="card-body">
                        <form action="<?= base_url('admin/dashboard/permissions/update') ?>" method="post">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="selectUser" type="text" placeholder="Nome" />
                                <label for="selectUser">Utente</label>
                            </div>
                            <input class="form-control" id="codice_fiscale" name="codice_fiscale" type="hidden" value=""/>
                            <div class="form-floating mb-3">
                                <select id="permissionsList" name="permissionsList" class="form-select" aria-label=".form-select-lg" style="padding-top: 0.625rem;" disabled>
                                    <option selected disabled>Seleziona il livello di permesso:</option>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0 float-end">
                                <input type="submit" class="btn btn-primary center" value="Modifica Permessi">
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Legenda Permessi</h3></div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap mb-0 rounded">
                                <thead class="thead-light">
                            <tr>
                                <th class="border-0 rounded-start">Permesso</th>
                                <th class="border-0 rounded-end">Livello</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td class="border-0">Accesso Completo</td>
                                <td class="border-0 font-weight-bold">10</td>
                            </tr>
                            <tr>
                                <td class="border-0">Modifica Personale</td>
                                <td class="border-0 font-weight-bold">8</td>
                            </tr>
                            <tr>
                                <td class="border-0">Visualizza Personale</td>
                                <td class="border-0 font-weight-bold">6</td>
                            </tr>
                            </tbody>
                        </table>
                        <div class="text-muted text-center" style="font-size: 12px">I livelli superiori ereditano i poteri dei livelli inferiori.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        const ac = new Autocomplete(field, {
            ...
            onSelectItem: ({label, value}) => {
                document.getElementById('selectUser').value = label;
                document.getElementById('codice_fiscale').value = value;
                document.getElementById('permissionsList').disabled = false;
            }
        });
